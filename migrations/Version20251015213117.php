 ...
 */
final class Version20251015213117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cage (id INT AUTO_INCREMENT NOT NULL, fonctionnalite_id INT NOT NULL, allee_id INT NOT NULL, numero_cage LONGTEXT NOT NULL, INDEX IDX_56A64E514477C5D8 (fonctionnalite_id), INDEX IDX_56A64E518E6975D2 (allee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
