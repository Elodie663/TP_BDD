...
class CarnetSante
{
    ...
    public function setDateCreation(\DateTime $date_creation): static { $this->date_creation = $date_creation; return $this; }
    public function getObservationsGenerales(): ?string { return $this->observations_generales; }
    public function setObservationsGenerales(?string $observations_generales): static { $this->observations_generales = $observations_generales; return $this; }

    // Vaccinations
    public function getVaccinations(): Collection { return $this->vaccinations; }
    ...
    // Contractions
    public function getContractions(): Collection { return $this->contractions; }
